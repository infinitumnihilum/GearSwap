...
function init_gear_sets()
    ...
    sets.precast.BloodPactWard = {ammo="Seraphicaller",head="Glyphic Horn",body="Glyphic Doublet",hands="Glyphic Bracers",
        back="Samanisi Cape",feet="Smn. Pigaches +2"}
    ...
    sets.precast.WS = {
        ...
        back="Pahtli Cape",waist="Cascade Belt",legs="Hagondes Pants",feet="Helios Boots"}
    ...
    sets.midcast.FastRecast = {
        ...
        back="Swith Cape +1",waist="Witful Belt",legs="Hagondes Pants",feet="Helios Boots"}
    ...
    sets.midcast['Elemental Magic'] = {main="Lehbrailg +2",sub="Wizzan Grip",
        ...
        back="Toro Cape",waist=gear.ElementalBelt,legs="Hagondes Pants",feet="Helios Boots"}
    ...
    sets.midcast.Pet.PhysicalBloodPactRage = {main="Soulscourge",ammo="Seraphicaller",
        ...
        waist="Diabolos's Rope",legs="Helios spats",feet="Convoker's Pigaches"}
    ...
    sets.midcast.Pet.MagicalBloodPactRage = {main="Eminent Pole",ammo="Seraphicaller",
        ...
        body="Convoker's Doublet",hands="Glyphic Bracers",ring1="Evoker's Ring",ring2="Fervor Ring",
        back="Samanisi Cape",waist="Diabolos's Rope",legs="Helios Spats",feet="Helios Boots"}
    ...
    sets.idle = {main="Bolelabunga",sub="Genbu's Shield",ammo="Seraphicaller",
        head="Caller's Horn +1",neck="Wiglen Gorget",ear1="Gifted Earring",ear2="Loquacious Earring",
    ...
    sets.idle.Avatar = {main="Gridarvor",sub="Achaq Grip",ammo="Seraphicaller",
        ...
        back="Conveyance Cape",waist="Fucho-no-Obi",legs="Nares Trews",feet="Helios Boots"}
    ...
    sets.idle.Spirit = {main="Gridarvor",sub="Achaq Grip",ammo="Seraphicaller",
        ...
        body="Bokwus Robe",hands="Serpentes Cuffs",ring1="Evoker's Ring",ring2="Sangoma Ring",
        back="Samanisi Cape",waist="Fucho-no-Obi",legs="Summoner's Spats",feet="Helios Boots"}

    sets.idle.Town = {main="Bolelabunga",sub="Genbu's Shield",ammo="Seraphicaller",
        head="Convoker's Horn",neck="Wiglen Gorget",ear1="Gifted Earring",ear2="Loquacious Earring",
        body="Bokwus Robe",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Sangoma Ring",
    ...
    sets.idle.Avatar.Melee = {hands="Regimen Mittens",back="Samanisi Cape",waist="Kuku Stone",legs="Helios spats"}
    ...
    sets.defense.PDT = {main=gear.Staff.PDT,
        ...
        back="Umbra Cape",waist="Fucho-no-Obi",legs="Hagondes Pants",feet="Helios Boots"}

    sets.defense.MDT = {
        head="Hagondes Hat",neck="Twilight Torque",ear1="Gifted Earring",ear2="Loquacious Earring",
        body="Vanir Cotehardie",hands="Yaoyotl Gloves",ring1="Defending Ring",ring2="Shadow Ring",
        back="Umbra Cape",waist="Fucho-no-Obi",legs="Bokwus Slops",feet="Helios Boots"}
    ...
    sets.engaged = {ammo="Seraphicaller",
        ...
        back="Conveyance Cape",waist="Goading Belt",legs="Hagondes Pants",feet="Helios Boots"}
end
