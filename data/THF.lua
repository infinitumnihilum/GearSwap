...
function init_gear_sets()
    ...
    sets.TreasureHunter = {hands="Plunderer's armlets +1", body="Volte Jupon",waist="Chaac Belt", feet="Skulker's poulaines +1"}
    ...
    sets.precast.JA['Steal'] = {head="Plunderer's Bonnet",hands="Adhemar wristbands +1",legs="Pillager's Culottes +2",feet="Pillager's Poulaines +1"}
    ...
    sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS, {ammo="Yetshila",
        head="Adhemar bonnet +1",body="Plunderer's vest +1",neck="Fotia gorget",waist="Fotia Belt",ear1="Odr earring",back=gear.ThfBack.CritWS, ear2="Moonshade Earring",ring2="Mummu ring"})
    sets.precast.WS['Evisceration'].Acc = set_combine(sets.precast.WS['Evisceration'], {ammo="Honed Tathlum", back="Letalis Mantle"})
    sets.precast.WS['Evisceration'].Mod = set_combine(sets.precast.WS['Evisceration'], {back=gear.ThfBack.CritWS,waist=gear.ElementalBelt})
    ...
    sets.precast.WS['Aeolian Edge'] = {ammo="Jukukik Feather",
        ...
        body="Wayfarer Robe",hands="Leyline Gloves",ring1="Acumen Ring",ring2="Demon's Ring",
    ...
    sets.idle = {ammo="Aurgelmir orb",
        head="Pillager's Bonnet +1",neck="Wiglen Gorget",ear1="Sherida earring",ear2="Telos Earring",
        body="Pillager's Vest +3",hands="Adhemar wristbands +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back=gear.ThfBack.TP,waist="Flume Belt +1",legs="Pillager's Culottes +2",feet="Fajin Boots"}

    sets.idle.Town = {main="Tauret", sub="Sandung",ammo="Aurgelmir orb",
        head="Pillager's Bonnet +1",neck="Wiglen Gorget",ear1="Sherida earring",ear2="Telos Earring",
        body="Pillager's Vest +3",hands="Adhemar wristbands +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back=gear.ThfBack.TP,waist="Windbuffet Belt +1",legs="Pillager's Culottes +2",feet="Fajin Boots"}
    ...
    sets.defense.PDT = {ammo="Iron Gobbet",
        ...
        body="Pillager's Vest +3",hands="Adhemar wristbands +1",ring1="Defending Ring",ring2="Moonlight Ring",
        back=gear.ThfBack.TP,waist="Flume Belt +1",legs="Malignance Tights",feet="Iuitl Gaiters +1"}

    sets.defense.MDT = {ammo="Demonry Stone",
        head="Pillager's Bonnet +1",neck="Twilight Torque",
        body="Pillager's Vest +3",hands="Adhemar wristbands +1",ring1="Defending Ring",ring2="Shadow Ring",
        back=gear.ThfBack.TP,waist="Flume Belt +1",legs="Pillager's Culottes +2",feet="Iuitl Gaiters +1"}
